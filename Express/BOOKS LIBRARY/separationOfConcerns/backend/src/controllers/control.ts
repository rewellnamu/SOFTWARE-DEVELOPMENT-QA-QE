  ...
  export const addBook=  async (req: Request, res: Response) => {
    try {
      ...
      const bookResult = await pool.query(
        `INSERT INTO books (title, author, genre, year, pages, publisher, description, image_url, price) 
  ...
  export const updateBook= async(req: Request, res: Response) => {
    try {
      ...
      const result = await pool.query(
        "UPDATE books SET title=$1, author=$2, genre=$3, year=$4, pages=$5, publisher=$6, description=$7, image_url=$8, price=$9, updated_at=NOW() WHERE id=$10 RETURNING *",
